...
The character values of unknown is denoted by _?_. We will replace the unknown value to median value of the series, and change the class to numeric. (we removed it)
